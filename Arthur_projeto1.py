...
st.title('Botafogo e sua relação com as Copas da Seleção brasileira')
st.subheader('Por: Arthur Vital')
st.write("O Botafogo é um dos clube mais tradicionais do brasil, sendo responsável diretamente por 3 das 5 Copas do Mundo do Brasil, mas entenda quando e onde tudo isso começou...")
...
if nome:
  st.write(nome,'é um cara muito legal!')
